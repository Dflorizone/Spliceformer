...
data_dir = os.path.join(os.environ['SLURM_TMPDIR'], 'v87')
out_path = os.path.join(os.environ['SLURM_TMPDIR'], 'v87', 'transformer_40k_test_mouse_ensembl_predictions_090725.csv.gz')
